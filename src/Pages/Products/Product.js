        ...
        <div className="card w-96 shadow-xl">
            ...
            <div className="card-body items-center text-center">
                ...
                <div className="card-actions">
                    <button className="btn btn-primary text-white bg-gradient-to-r from-primary to-secondary hover:from-secondary hover:to-primary" onClick={() => gotoPurchase(`/purchase/${_id}`)}>Buy Now</button>
                </div>
            </div>
        </div>
    );
